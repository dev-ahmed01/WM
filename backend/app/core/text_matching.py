...
_STOP_WORDS = {
    "a", "an", "and", "are", "do", "does", "for", "how", "i", "if", "in", "is", "it",
    "give", "me", "navigate", "next", "of", "on", "open", "please", "show", "sop", "start",
    "step", "steps", "should", "the", "its", "need", "not", "purpose", "reason", "to", "what",
    "when", "where", "why", "with", "workflow", "you",
}
